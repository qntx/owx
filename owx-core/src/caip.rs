//! CAIP-2 chain identifier type with validation.
...
///
/// Validates that the namespace is 3–8 lowercase alphanumeric characters and the
/// reference is 1–64 alphanumeric/dash/underscore characters per the
...
impl ChainId {
    /// Validate namespace: 3–8 lowercase alphanumeric characters.
    ...
    /// Validate reference: 1–64 alphanumeric, dash, or underscore characters.
